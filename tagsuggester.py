...
def sampleface():
    ...
    return f"https://google.com/search?q={keyword}+{cleaned_sample}+{cleaned_sf_cats_sample}"
...
def cultrface():
    ...
    if keyword:
        return 'https://google.com/search?q=' + f'{keyword}+' + '+'.join(sample).lower().replace('come in god','religion').replace(' ', '+').replace('&', '').replace('\u00e9', 'e').replace('#039;', "'")
    else:
        return 'https://google.com/search?q=' + '+'.join(sample).lower().replace(' ', '+').replace('&', '').replace('\u00e9', 'e').replace('#039;', "'")
...
def logicface():
    ...
    return f"https://google.com/search?q={keyword}+{cleaned_sample}+{cleaned_lf_cats_sample}"
...
def playrface():
    ...
    return f"https://google.com/search?q={keyword}+{cleaned_sample}+{cleaned_pf_cats_sample}"
...
def distantarcade():
    ...
    return f"https://google.com/search?q={keyword}+{cleaned_sample}+{cleaned_da_cats_sample}"
